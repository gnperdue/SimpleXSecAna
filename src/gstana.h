...
#ifdef gstana_cxx
gstana::gstana(TTree *tree) : fChain(0) 
{
...
Int_t gstana::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gstana::LoadTree(Long64_t entry)
{
...
void gstana::Show(Long64_t entry)
{
...
Int_t gstana::Cut(Long64_t entry)
{
